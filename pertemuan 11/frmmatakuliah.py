...
class FormMatakuliah:
    ...
    def aturKomponen(self):
        ...
        self.sks = StringVar()
        sks_values = ['1', '2', '3', '4', '5', '6']
        for i, sks_val in enumerate(sks_values):
            rb = Radiobutton(mainFrame, text=sks_val, value=sks_val, variable=self.sks)
            rb.grid(row=2 + i , column=1, padx=5, pady=5, sticky=tk.W)
            rb.select()
