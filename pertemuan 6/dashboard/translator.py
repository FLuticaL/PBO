...
class FrmTranslator:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='French:').grid(row=2, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Japanese:').grid(row=3, column=0,
            sticky=W, padx=5, pady=5)        
        Label(mainFrame, text='Germany:').grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
    ...
    def onTranslate(self, event=None):
        # membuat instance object
        penterjemah = Translator()

        # menterjemahkan
        hasil1 = penterjemah.translate(self.txtSumber.get(), src='id', dest='fr')
        hasil2 = penterjemah.translate(self.txtSumber.get(), src='id', dest='ja')        
        hasil3 = penterjemah.translate(self.txtSumber.get(), src='id', dest='de')        
