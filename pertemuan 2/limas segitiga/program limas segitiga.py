...
hitung_button = Button(Frame, text="Hitung Volume", command = hitung_volume, bg = 'brown')
...
nama.grid(row=10, column=0, sticky=W, padx=5, pady=5)

NIM = Label(Frame, text='220511179')
NIM.grid(row=11, column=0, sticky=W, padx=5, pady=5)
